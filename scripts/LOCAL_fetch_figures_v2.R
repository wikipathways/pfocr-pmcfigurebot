...
#
# Usage:
# Prepare a YAML config file (query_config.yml) with terms, 
# last_run (or date_range), and exclude_figids.
# This file is meant to be in a parent dir, which should also be the set
# working directory.
# Then Rscript LOCAL_fetch_figures_v2.R
#
# Output:
